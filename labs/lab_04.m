...
saveas(gcf, 'Максимальная_устойчивость.png');
...
saveas(gcf, 'Граничная_устойчивость.png');
...
plot(1.7,3.0,'b*');
plot(1.7,1.26,'g*');
legend('Зависимость','Устойчивый', 'Неустойчивый', 'На границе устойчивости')
grid on
xlabel('T, sec')
ylabel('Kкр')
title('Граница устойчивости системы');
saveas(gcf, 'Граница_области.png');


%% Ниже границы устойчивости

name = 'Устойчивая система (ниже границы устойчивости)';
road = 'Устойчивая_система.png';
color = 'r-';
...
road = 'На_границе_устойчивости.png';
color = 'g-';
